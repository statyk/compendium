...
@items_lifecycle_router.post("/{barcode}/verify-returned", response_model=ItemDetail)
def verify_returned(
    barcode: str,
    session: Session = Depends(get_session),
...
@items_lifecycle_router.post("/{barcode}/write-off-claim", response_model=ItemDetail)
def write_off_claim(
    barcode: str,
