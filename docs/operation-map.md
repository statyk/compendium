...
| **patrons** | add, edit, list/search, deactivate/reactivate, link/unlink user, create account | `compendium patron …` | `POST /patrons`, `GET /patrons`, `PATCH /patrons/{card}`, `POST /patrons/{card}/{deactivate,reactivate,account}` |
